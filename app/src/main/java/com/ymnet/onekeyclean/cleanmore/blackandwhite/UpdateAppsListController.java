 ...
 * @author janan
 * @version since
 * @date 2014-5-13 上午11:20:44
 * @description updateappslist操作类，可以对updateappslist做操作
 *//*
...
public class UpdateAppsListController implements BlackAndWhiteList<AppBAWLocal>
{
    ...
    protected UpdateAppsListController(Context cxt)
    {
        init(cxt);
    }
    ...
    {
        this.mContext = cxt;
        this.appsList = new UpdateAppsList(mContext);
    }
