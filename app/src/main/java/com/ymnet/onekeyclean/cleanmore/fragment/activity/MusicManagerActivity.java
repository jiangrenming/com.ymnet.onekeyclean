...
public class MusicManagerActivity extends ImmersiveActivity implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        tvTopTitle.setText(R.string.music_clean);
        ...
        noDocument.setText(R.string.music_dir_empty);
    ...
    private void initData(final Context context) {
        ...
        AsyncTaskwdh<Void, Void, Void> task = new AsyncTaskwdh<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                ArrayList<FileInfo> infos = fc.getAllMusic(context, FileSortHelper.SortMethod.size);
        ...
        AsyncTaskwdh<Void, Void, Void> task = new AsyncTaskwdh<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                while (iterator.hasNext() && mInfos != null) {
                    next = iterator.next();
                    if (next != null) {
                        boolean b = FileBrowserUtil.deleteMusic(context, next.getValue().fileId,
