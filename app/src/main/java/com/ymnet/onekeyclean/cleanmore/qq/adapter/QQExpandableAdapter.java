...
public class QQExpandableAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
    ...
    public QQExpandableAdapter(Activity activty, QQDetailPresenter presenter, QQPicMode type) {
        mActivty = activty;
        ...
        computeSdvWidth(activty);
    }

    private void computeSdvWidth(Activity activty) {
        height = (DeviceInfo.getScreenWidth(activty) - DisplayUtil.dip2px(activty, 12)) / 3;
    }
...
//                setController(ch.sdv2, UriUtil.parseUriOrNull("file://" + itemDatas[2].path));
    ...
    static class ChildHolder {
        ...
        public ImageView cb_status0, cb_status1, cb_status2,sdv0, sdv1, sdv2;
