...
public class FileSortHelper
{
    ...
    {
        return mComparatorList.get(sortMethod);
    }
    ...
    private Comparator cmpType = new FileComparator()
    {
        ...
        public int doCompare(FileInfo object1, FileInfo object2)
        {
            int result = FileBrowserUtil.getExtFromFilename(object1.fileName).compareToIgnoreCase(FileBrowserUtil.getExtFromFilename(object2.fileName));
            if (result != 0)
                return result;
            
            return FileBrowserUtil.getNameFromFilename(object1.fileName).compareToIgnoreCase(FileBrowserUtil.getNameFromFilename(object2.fileName));
        }
    };
}
