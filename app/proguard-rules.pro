...
# in D:\programeSoft\android-studio-ide-143.2443734-windows\sdk/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class [com.ymnet.onekeyclean].** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class [com.ymnet.onekeyclean].R$*{
